...
const FAQ = () => {
  ...
  return (
    <section
      id="faqs"
      className="bg-white py-20 px-30 sm:px-10 lg:px-20 font-lato"
    >
      <div className="max-w-4xl mx-auto">
        {/* Heading */}
        <h2 className="text-4xl md:text-5xl font-extrabold text-center font-poppins text-vibrantBlue">
        ...
        <motion.div
          ...
          className="h-1 bg-vibrantBlue rounded-full w-full sm:w-50 md:w-64 mx-auto mt-4"
        />
          ...
          {faqs.map((faq, index) => (
            ...
            >
              ...
              <button
                ...
                className={`w-full flex justify-between items-center px-6 py-4 font-semibold text-lg  cursor-pointer font-poppins transition-colors duration-300 text-white bg-deepNavyBlue`}
              >
                {faq.question}
              ...
              <AnimatePresence initial={false}>
                {openIndex === index && (
                  ...
                  >
                    <div className="px-10 py-6 text-black font-lato bg-gray-50 leading-relaxed">
                      {faq.answer}
                    </div>
                  </motion.div>
                )}
