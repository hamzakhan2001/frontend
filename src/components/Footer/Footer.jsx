...
export default function Footer() {
  return (
    <footer className="bg-deepNavyBlue text-white pt-10 pb-10 px-30 border-t border-gray-700">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-6 md:gap-8 lg:gap-10">
        {/* Branding + CTA */}
        <div>
          <img src={logo} alt="logo" className="mb-5 w-full" />
          ...
          <a
            ...
            className="font-lato cursor-pointer px-6 py-3 rounded-full font-semibold text-white bg-gradient-to-r from-[#00b4d8] to-[#0077b6] hover:from-[#0077b6] hover:to-[#00b4d8] transition-all duration-300 shadow-lg"
          >
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li>
              <a href="#services" className="hover:text-vibrantBlue">
                Brand Management
              </a>
            </li>
            <li>
        ...
        <div>
          ...
          <p className="text-sm mb-2">
            Hayzel Technologies, Defense Avenue, DHA Phase 1, near Foundation
          ...
          <div className="flex gap-5 text-lg">
            <a
              href="https://www.facebook.com/HayzelTech"
              target="_blank"
              className="hover:text-vibrantBlue transition"
            >
              <FaFacebookF />
            </a>
            <a
              href="https://www.instagram.com/hayzel.technologies/?hl=en"
              target="_blank"
              className="hover:text-vibrantBlue transition"
            >
              <FaInstagram />
            ...
            <a
              href="https://www.linkedin.com/company/hayzeltechnologies"
              target="_blank"
              className="hover:text-vibrantBlue transition"
            >
              <FaLinkedinIn />
