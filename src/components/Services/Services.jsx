...
const Services = () => {
  ...
  return (
    <section
      id="services"
      className="relative p-30 sm:p-20 bg-deepNavyBlue flex flex-col items-center border-t border-gray-700"
    >
      {/* Top Heading */}
        {/* Heading */}
     <motion.div
        ...
        <p className="text-white text-md font-lato text-center max-w-2xl px-6 mb-15">
      ...
      {/* Services cards */}
      <div
        className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 w-[90%] max-w-7xl"
            ...
            >
              ...
              >
                ...
                <div className="card-face card-back">
                  <p className="font-lato text-base">{service.desc}</p>
                </div>
              </motion.div>
            </motion.div>
          );
